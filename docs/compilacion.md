...
El paquete incluye los cinco componentes (`Controls/id5_ID10005.<Control>/`), el manifiesto de solución (`ID0005_DataPickers`, versión 1.0.0.9, publicador `ID0005`, prefijo `id5`) y los recursos `Other/Solution.xml`, `Other/Customizations.xml` y `Other/Relationships.xml`.
