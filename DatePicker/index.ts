/**
 * Fecha: 2026-09-16
 * Descripcion: Adaptador PCF del selector de fecha simple. Conecta el ciclo de
 * vida de Power Apps con la vista React y publica la fecha seleccionada.
 */
import { IInputs, IOutputs } from "./generated/ManifestTypes";
import { DatePickerView, IDatePickerProps } from "./DatePickerView";
import * as React from "react";

export class DatePicker implements ComponentFramework.ReactControl<IInputs, IOutputs> {
    private notifyOutputChanged: () => void;
    private date = "";
    private lastInputDate = "";
    ...
    public updateView(context: ComponentFramework.Context<IInputs>): React.ReactElement {
        ...
        if (resetKey !== this.lastResetKey) {
            this.date = "";
            this.lastInputDate = inputDate;
            this.lastResetKey = resetKey;
        } else if (inputDate !== this.lastInputDate) {
            this.date = inputDate;
            this.lastInputDate = inputDate;
        }

        const props: IDatePickerProps = {
            date: this.date,
